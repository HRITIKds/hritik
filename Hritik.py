...
def main():
	...
	print "   [08] social account "
	print "   [09] Other\n"
	print "   [10] Exit the hritik\n"
	Hritik = raw_input("hritikds > ")

	if Hritik == "1" or Hritik == "01":
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		print "    [04] sqlmap"
		...
		infogathering = raw_input("hritikds > ")
